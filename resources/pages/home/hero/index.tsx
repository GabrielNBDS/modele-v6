    ...
    <div className={s.inner}>
      <div className={s.content}>
        <Title className={s.title}>
          A <span className={s.highlight}>modern</span> React <br /> components library
        </Title>
        <Text c="dimmed" mt="md">
        ...
        <Group mt={30}>
          <Button radius="xl" size="md" className={s.control}>
            Get started
          </Button>
          <Button variant="default" radius="xl" size="md" className={s.control}>
            Source code
          </Button>
        </Group>
      </div>
